Pod::Spec.new do |s|
  s.name         = "libPhoneNumber-iOS-sdkdimon"
  s.version      = "1.0.5"
...
DESC
  ...
  s.source       = { :git => "https://github.com/sdkdimon/libPhoneNumber-iOS.git", :tag => s.version.to_s }
  s.module_name = 'libPhoneNumber_iOS'
  s.module_map = 'libPhoneNumber/libPhoneNumber-iOS.modulemap'
  s.libraries 	 = 'z'
